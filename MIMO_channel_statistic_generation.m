...
% lgDSmean=-0.204*log10(1+ fc) - 6.28;   %UMa

lgDSstanvar=0.16*log10(1+ fc) + 0.28; %UMi - Street Canyon  NLOS
% lgDSstanvar=0.39; % UMa
...
lgASAstanvar=0.05*log10(1+ fc) + 0.3;  %UMi - Street Canyon  NLOS

% lgASAmean=-0.27*log10(fc) + 2.08;   %UMa
% lgASAstanvar=0.11;  %UMa
...
lgASDstanvar=0.11*log10(1+ fc) + 0.33; %UMi - Street Canyon  NLOS

% lgASDmean=-0.1144*log10(1+ fc) + 1.5;   %UMa
% lgASDstanvar=0.28; %UMa
...
lgZSAstanvar=-0.07*log10(1+ fc) + 0.41;%UMi - Street Canyon  NLOS

% lgZSAmean=-0.3236*log10(1+ fc) + 1.512;   %UMa
% lgZSAstanvar=0.16;%UMa
